  ...
  data: {
    WALLET: {
      ...
      CONCEPTS: {
        ...
        DRIVER_PAYMENT_FOR_APP_CLIENT_SERVICE: 'Pago por Servicio App Cliente',
        APP_DRIVER_AGREEMENT_PAYMENT_REFUND: 'Reembolso Pago parcial de cliente',
        DRIVER_PAYMENT_FOR_APP_CLIENT_SERVICE_REFUND: 'Reembolso Pago por Servicio App Cliente',
    ...
    ERRORS: {
      ...
      19007: 'Transacción No Disponible',
