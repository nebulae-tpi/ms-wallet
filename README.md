...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-tpi/ms-wallet.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-tpi/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-wallet/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-wallet/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-tpi/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-wallet/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-wallet/etc/emi-mapi-setup.json
```
